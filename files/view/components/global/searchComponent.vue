        ...
        <form :action="search.searchUrl" method="get" @submit.prevent="searchTable()">
            <div class="row">
                ...
                <div class="customSearch col" v-if="useCustomSearch || columns">
                    <button class="btn btn-success btn-block" @click="toggleCustomSearch">
                        Custom Search
    ...
    methods: {
        searchTable() {
            ...
            this.$emit("searchTableData", {
                url: this.search.searchUrl,
                search: this.searchPhrase,
                customSearch: this.customSearchData
            });
